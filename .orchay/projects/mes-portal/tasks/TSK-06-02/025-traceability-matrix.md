...
| BR-007 | 보안 요구사항 | 8.1 | API 레이어 | - | E2E-010 | API 레벨 권한 검증 확인 | 설계완료 |
| BR-008 | 데이터 정합성 | 8.1 | API 레이어 | - | E2E-011 | 소프트 삭제 후 deletedAt 필드 설정 확인 | 설계완료 |
...
| UC-03: 수정 화면 이동 | FR-003, FR-006 | BR-001, BR-007 |
| UC-04: 삭제 | FR-004 | BR-001, BR-007, BR-008 |
| UC-05: 목록 복귀 | FR-006 | - |
| UC-06: 로딩 상태 표시 | FR-005 | - |
| UC-07: 에러 상태 표시 | FR-005 | BR-005 |
...
| 1.1 | 2026-01-21 | Claude | 리뷰 반영 - UC-06/UC-07 매핑 추가, BR-007/BR-008 추가 |
