...
|-------------|----------|--------------|--------------|-------------|------------|-----------|------|
| FR-001 | 4.1.1 화면 템플릿 | 5.1, 7.1 | - | UT-001, UT-002, UT-003, UT-004 | E2E-001, E2E-007, E2E-008 | TC-001, TC-002, TC-003 | 설계완료 |
| FR-002 | 4.1.1 폼 검증 | 3.2, 8.1, 9.1, 10.1 | - | UT-005, UT-006, UT-007, UT-013 | E2E-002, E2E-006 | TC-004, TC-005 | 설계완료 |
| FR-003 | 4.1.1 폼 검증 | 4.2, 6.1, 8.1 | - | UT-008, UT-009, UT-010 | E2E-003, E2E-005 | TC-006, TC-008 | 설계완료 |
| FR-004 | 4.1.1 폼 상태 관리 | 4.2, 6.2 | - | UT-014, UT-015 | E2E-004, E2E-009 | TC-009 | 설계완료 |
| FR-005 | 4.1.1 폼 상태 관리 | 3.2 (UC-06) | - | UT-011, UT-012 | E2E-010 | TC-010 | 설계완료 |
...
| 단위 테스트 | 026-test-specification.md | - | UT-014: 필드 변경 감지, UT-015: dirty 상태 시각적 표시 |
| E2E 테스트 | 026-test-specification.md | - | E2E-004: 수정 모드에서 변경 필드 하이라이트 검증, E2E-009 |

#### FR-005: 폼 초기화/리셋 - 입력한 내용을 초기 상태로 복원

| 설계 단계 | 문서 | 섹션 | 구현 항목 |
|----------|------|------|----------|
| PRD | prd.md | 4.1.1 폼 상태 관리 | 폼 초기화/리셋 기능 |
| 기본설계 | 010-design.md | 3.2 (UC-06) | 유즈케이스: 폼 초기화 |
| 기본설계 | 010-design.md | 7.2 | Props: onReset?: () => void, showReset?: boolean |
| 단위 테스트 | 026-test-specification.md | - | UT-011: 초기화 버튼 렌더링, UT-012: 초기화 동작 |
| E2E 테스트 | 026-test-specification.md | - | E2E-010: 폼 초기화 후 상태 확인 |
...
|---------|----------|--------------|-----------------|-------------|------------|-----------|------|
| BR-001 | 4.1.1 폼 검증 | 8.1 (BR-01) | FormTemplate | UT-006, UT-013 | E2E-002, E2E-006 | 저장 전 유효성 검사 필수, 첫 에러 필드로 포커스 | 설계완료 |
| BR-002 | 4.1.1 폼 상태 관리 | 8.1 (BR-02) | FormTemplate | UT-010 | E2E-004, E2E-010 | 변경 시 이탈 확인 다이얼로그 표시 | 설계완료 |
| BR-003 | 4.1.1 폼 검증 | 8.1 (BR-03) | FormTemplate | UT-005 | E2E-002 | 필수 필드 라벨에 * 표시 | 설계완료 |
| BR-004 | 4.1.1 로딩 상태 | 8.1 (BR-04) | FormTemplate | UT-008 | E2E-005 | 저장 중 중복 클릭 방지 | 설계완료 |
| BR-005 | 4.1.1 폼 검증 | 8.1 (BR-05) | FormTemplate | UT-013 | E2E-002 | 유효성 실패 시 첫 에러 필드로 포커스 | 설계완료 |
| BR-006 | 4.1.1 폼 상태 관리 | 8.1 (BR-06) | FormTemplate | UT-014 | E2E-009 | 수정된 필드 시각적 표시 (수정 모드) | 설계완료 |
...
| UT-005 | 단위 | FR-002 | BR-003 | 미실행 |
| UT-006 | 단위 | FR-002 | BR-001 | 미실행 |
| UT-007 | 단위 | FR-002, FR-003 | - | 미실행 |
| UT-008 | 단위 | FR-003 | BR-004 | 미실행 |
| UT-009 | 단위 | FR-003 | - | 미실행 |
| UT-010 | 단위 | FR-003 | BR-002 | 미실행 |
| UT-011 | 단위 | FR-005 | - | 미실행 |
| UT-012 | 단위 | FR-005 | - | 미실행 |
| UT-013 | 단위 | FR-002 | BR-001, BR-005 | 미실행 |
| UT-014 | 단위 | FR-004 | BR-006 | 미실행 |
| UT-015 | 단위 | FR-004 | - | 미실행 |
| E2E-001 | E2E | FR-001, FR-003 | - | 미실행 |
| E2E-002 | E2E | FR-002 | BR-001, BR-003 | 미실행 |
| E2E-003 | E2E | FR-003 | - | 미실행 |
| E2E-004 | E2E | FR-004 | BR-002 | 미실행 |
| E2E-005 | E2E | FR-003 | BR-004 | 미실행 |
| E2E-006 | E2E | FR-002 | BR-001 | 미실행 |
| E2E-007 | E2E | FR-001 | - | 미실행 |
| E2E-008 | E2E | FR-001 | - | 미실행 |
| E2E-009 | E2E | FR-004 | BR-006 | 미실행 |
| E2E-010 | E2E | FR-005 | BR-002 | 미실행 |
| TC-001 | 매뉴얼 | FR-001 | - | 미실행 |
| TC-002 | 매뉴얼 | FR-001 | - | 미실행 |
| TC-003 | 매뉴얼 | FR-001 | - | 미실행 |
| TC-004 | 매뉴얼 | FR-002 | BR-003 | 미실행 |
| TC-005 | 매뉴얼 | FR-002 | BR-001 | 미실행 |
| TC-006 | 매뉴얼 | FR-003 | - | 미실행 |
| TC-007 | 매뉴얼 | FR-003 | - | 미실행 |
| TC-008 | 매뉴얼 | FR-003 | BR-004 | 미실행 |
| TC-009 | 매뉴얼 | FR-004 | BR-006 | 미실행 |
| TC-010 | 매뉴얼 | FR-005 | - | 미실행 |
| TC-011 | 매뉴얼 | - | - | 미실행 |
| TC-012 | 매뉴얼 | - | - | 미실행 |
