...
| FR-006 | 4.1.1 화면 템플릿 | 5.1 Steps, 11.7 | UT-008 | E2E-001 | TC-001 | 설계완료 |
...
#### FR-006: 진행 상황 시각화 (QA-002 반영)

| 설계 단계 | 문서 | 섹션 | 구현 항목 |
|----------|------|------|----------|
| PRD | prd.md | 4.1.1 | 단계별 진행 - 진행 상황 표시 |
| 기본설계 | 010-design.md | 5.1 와이어프레임, 11.7 data-testid | Ant Design Steps로 현재/완료/대기 상태 시각화 |
| 단위 테스트 | 026-test-specification.md | UT-008 | 현재 단계 강조, 단계 상태 표시 |
| E2E 테스트 | 026-test-specification.md | E2E-001 | 단계 진행에 따른 인디케이터 업데이트 |
...
| BR-005 | 4.1.1 | 8.1 BR-05 | WizardTemplate | - | E2E-006 | 데이터 있을 때 이탈 확인 다이얼로그 표시 | 설계완료 |
| BR-006 | 4.1.1 | 8.1 BR-06 | WizardNavigation | UT-006 | E2E-001 | 완료 버튼은 마지막 단계에서만 표시 | 설계완료 |
| BR-007 | 4.1.1 | 8.1 BR-07 | WizardTemplate | UT-015 | E2E-004 | 완료 처리 중 중복 클릭 방지 (버튼 disabled) | 설계완료 |
| BR-008 | 4.1.1 | 8.1 BR-08 | WizardContext | - | E2E-003 | 이전/다음 이동 시 단계 간 데이터 유지 | 설계완료 |
...
| 1.1 | 2026-01-21 | Claude | 설계 리뷰 반영 - QA-002(FR-006 추가), QA-007(BR-005~008 추가), 커버리지 통계 업데이트 |
